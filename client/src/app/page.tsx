          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-5">
              <PageNavCard
                ...
                description="Look up your Senators and House members by state. See their photos, party, and contact info."
              ...
              <PageNavCard
                href="/climate-impact"
                title="View Climate Data"
                description="Track US air quality, water quality, and climate metrics against EPA standards and Paris Agreement goals."
                icon={<svg className="w-5 h-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
              />
              <PageNavCard
                href="/graph"
                title="Policy Radar"
                description="Interactive charts and visualizations showing environmental legislation trends and relations between areas of climate policy."
              ...
              <PageNavCard
                ...
                icon={<svg className="w-5 h-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>}
              />
              <PageNavCard
                href="/search"
                title="Search Bills"
                description="Find specific environmental bills using our intelligent search engine."
